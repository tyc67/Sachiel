export enum MobielCreateCollectionStep {
  ...
  Step4SortStories = 'mobile-step-4-sort-stoires',
}

export enum DesktopCreateCollectionStep {
  Step1EditAll = 'desktop-step-1-edit-all',
  Step2SortStories = 'desktop-step-2-sort-stories',
}
